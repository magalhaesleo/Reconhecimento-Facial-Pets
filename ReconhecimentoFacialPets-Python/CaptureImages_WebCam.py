...
face_cascade = cv2.CascadeClassifier('../haarcascades/haarcascade_frontalcatface.xml') # Classifier "frontal-face" Haar Cascade
eye_cascade = cv2.CascadeClassifier('../haarcascades/haarcascade_eye.xml') # Classifier "eye" Haar Cascade
