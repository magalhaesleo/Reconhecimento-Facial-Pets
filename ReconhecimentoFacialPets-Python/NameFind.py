...
face = cv2.CascadeClassifier('../haarcascades/haarcascade_frontalcatface.xml') # Classifier "frontal-face" Haar Cascade
glass_cas = cv2.CascadeClassifier('../haarcascades/haarcascade_eye_tree_eyeglasses.xml') # Classifierde "eye" Haar Cascade
